 ...
 * Tương tác Follow/Like 100% qua GraphQL Comet MWeb (không dùng REST cũ) để chống triệt để HTTP 429.
...
class InstagramClient(
    ...
    companion object {
        ...
        const val DOC_ID_LIKE_MUTATION_FALLBACK = "26233076846342880"
        const val DOC_ID_LIKE_MUTATION_LEGACY = "9595477160535898"
    ...
    /**
     * 2. Follow tài khoản Instagram bằng Comet MWeb GraphQL Mutation (usePolarisFollowMutation)
     */
    ...
    /**
     * 3. Like bài viết Instagram bằng GraphQL Mutation (PolarisAPILikePostMutation / usePolarisLikeMediaLikeMutation)
     */
